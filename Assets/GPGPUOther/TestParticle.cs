...
public class TestParticle : MonoBehaviour 
{
	...
	struct Particle
	{
		public Vector3 position; //float = 4 bytes 
	...
	void Start () 
	{
		...
		particleBuffer = new ComputeBuffer(particleCount, System.Runtime.InteropServices.Marshal.SizeOf(typeof(Particle)) ); // 24 = sizeof(Particle)
	...
	void Update () 
	{
		...
		Vector3 pos = ray.direction * 50.0f;
		target[0] = pos.x;
		target[1] = pos.y;
		target[2] = pos.z;
