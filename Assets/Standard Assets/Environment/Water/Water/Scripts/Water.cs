...
//            }
        ...
        WaterMode FindHardwareWaterSupport()
        {
            ...
            {
				Debug.Log("Support RenderTextureds: "+SystemInfo.supportsRenderTextures);
				Debug.Log("Has Renderer: "+!GetComponent<Renderer>() + "Leaving...");
            ...
            if (!mat)
            {
				Debug.Log("no Map returning Simple");
                return WaterMode.Simple;
            }
